...
public class NEFTTransfer implements Serializable {
	...
	@Column
	private LocalDateTime neft_intiated_date;
	...
	public LocalDateTime getNeft_intiated_date() {
		return neft_intiated_date;
	}

	public void setNeft_intiated_date(LocalDateTime neft_intiated_date) {
		this.neft_intiated_date = neft_intiated_date;
	}
